...
export default function AdminTags() {
  ...
  async function handleSave(e) {
    ...
    try {
      if (modal.mode === "add") {
        ...
        const updated = await tagService.update(modal.item.id, {
          name,
          active,
        });
  ...
  return (
    <>
      <Topbar
        title="Tags"
        subtitle="Reference data used to label problems (e.g. Two Pointers, Recursion)."
      />
      ...
      <Modal
        ...
        title={modal?.mode === "add" ? "Add tag" : "Edit tag"}
        width={400}
      >
